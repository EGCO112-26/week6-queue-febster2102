...
int dequeue_struct(Queue *q, int customer_count) { //dequeue
    ...
    if (t) {
        ...
        switch(menu_id) {
            case 1: strcpy(menu_name, "moo deng prik pao"); price = 15000 * qty; break;
            case 2: strcpy(menu_name, "ba boon tod nam pla"); price = 2000 * qty; break;
            case 3: strcpy(menu_name, "pla wan pao"); price = 4000 * qty; break;
            case 4: strcpy(menu_name, "som tam pla too"); price = 1200 * qty; break;
